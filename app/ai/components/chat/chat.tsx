...
import { CHAT_PAGE_SIZE, REQUEST_TIMEOUT_MS } from "@/app/constant";
import Locale from "@/app/locales";
import { ChatMessage, createMessage } from "@/app/store";
...
const Markdown = dynamic(
  async () => (await import("@/app/components/ui/markdown")).Markdown,
  {
    loading: () => <Loading />,
  },
);
...
export function Chat() {
  ...
  return (
    <div className="flex flex-col relative h-full" key={bot.id}>
      ...
      <Separator />
      <div className="relative w-full box-border flex-col pt-2.5 p-5 space-y-1">
