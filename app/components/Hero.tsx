...
export function Hero() {
  ...
  return (
    <Container className="pt-40 pb-40 text-center lg:pt-32 bg-gradient-to-r from-[#eff3f9] to-[#ffffff] via-[rgba(144,238,144,0.2)]">
      <h1 className="font-display mx-auto max-w-4xl text-5xl font-bold tracking-tight text-slate-900 sm:text-7xl">
        <span className="relative whitespace-nowrap text-green-600">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute top-2/3 left-0 h-[0.58em] w-full fill-black-300/70"
        ...
        Generate Your Individual AI BOT
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-xl tracking-tight text-slate-700">
        ...
        <div className="mt-9 flex justify-center gap-x-6 items-center ">
            <Link href="/myBot">
                <Button className="w-full mx-auto text-base">
                    <div className="flex items-center gap-2">
                        <PlusCircle className="mr-2 h-4 w-4" /> {Locale.Home.create}
                    </div>
                </Button>
            </Link>
            ...
            <Link href="/market">
                <Button className="w-full mx-auto text-base">
                    <div className="flex items-center gap-2">
                        <FireIcon className="mr-2 h-4 w-4" /> {Locale.Home.market}
                    </div>
                </Button>
            </Link>
        </div>
