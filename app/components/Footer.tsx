            ...
            <div className="max-w-8xl mx-auto px-4 sm:px-6" style={{ backgroundColor: 'rgb(24, 24, 24)' }}>
                ...
                <div className="md:flex md:items-center md:justify-between py-4 md:py-8">
                    ...
                    <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
                        <li className="ml-4">
                            <a href="https://github.com/AAooWW/Bigit" className="flex justify-center items-center text-gray-200 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github">
                    ...
                    {/* Copyrights note */}
                    <div className="text-sm text-gray-200 mr-4">&copy; Bigit 2023 </div>
